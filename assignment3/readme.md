...
The project will be developed in DSL language using JetBrains MPS software. It will be the description of a language to configure a state machine, with states, transitions and events.
Problem
